...
func ID(id int) predicate.OutboundShipping {
...
func IDEQ(id int) predicate.OutboundShipping {
	return predicate.OutboundShipping(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.OutboundShipping {
	return predicate.OutboundShipping(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.OutboundShipping {
	return predicate.OutboundShipping(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.OutboundShipping {
	return predicate.OutboundShipping(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int) predicate.OutboundShipping {
	return predicate.OutboundShipping(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.OutboundShipping {
	return predicate.OutboundShipping(func(s *sql.Selector) {
...
func IDLT(id int) predicate.OutboundShipping {
	return predicate.OutboundShipping(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.OutboundShipping {
	return predicate.OutboundShipping(func(s *sql.Selector) {
