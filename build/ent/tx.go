...
func (tx *Tx) init() {
	...
	tx.OutboundDeal = NewOutboundDealClient(tx.config)
	tx.OutboundShipping = NewOutboundShippingClient(tx.config)
	tx.OutboundTransaction = NewOutboundTransactionClient(tx.config)
	tx.Product = NewProductClient(tx.config)
	tx.Variant = NewVariantClient(tx.config)
	tx.Variation = NewVariationClient(tx.config)
}
