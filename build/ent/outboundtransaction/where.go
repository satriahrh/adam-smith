...
func ID(id uint64) predicate.OutboundTransaction {
...
func IDEQ(id uint64) predicate.OutboundTransaction {
	return predicate.OutboundTransaction(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id uint64) predicate.OutboundTransaction {
	return predicate.OutboundTransaction(func(s *sql.Selector) {
...
func IDIn(ids ...uint64) predicate.OutboundTransaction {
	return predicate.OutboundTransaction(func(s *sql.Selector) {
...
func IDNotIn(ids ...uint64) predicate.OutboundTransaction {
	return predicate.OutboundTransaction(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id uint64) predicate.OutboundTransaction {
	return predicate.OutboundTransaction(func(s *sql.Selector) {
...
func IDGTE(id uint64) predicate.OutboundTransaction {
	return predicate.OutboundTransaction(func(s *sql.Selector) {
...
func IDLT(id uint64) predicate.OutboundTransaction {
	return predicate.OutboundTransaction(func(s *sql.Selector) {
...
func IDLTE(id uint64) predicate.OutboundTransaction {
	return predicate.OutboundTransaction(func(s *sql.Selector) {
